        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="flex flex-col gap-4">
              {[
                ['icon-perawatan.png', 'Syarat Sewa yang Ringan dan Tidak Ribet'],
                ['icon-motorbaru.png', 'Kualitas iPhone Terjamin dan Sudah Legal'],
          ...
          <div className="flex flex-col gap-4">
            {[
              ['icon-terpercaya.png', 'Verifikasi Data Cepat dan Mudah'],
              ['icon-dokumen.png', 'Terbuka untuk Semua Kalangan'],
